<?php 
  ...
  */
  ...
  if( $preflv == "" && $prefsid == ""){
    ...
    $insert_sql = "INSERT INTO post (`pid`, `ptitle`, `pcontent`, `pcredate`, `prefuid`, `preflv`, `prefsid`, `ptype`, `pcount`, `ptag`, `pcategory`, `pstate`, `pexpiration`, `pattachment_id`, `hide_script`) VALUES ";
    $insert_sql .= "('".$maxPid."', '".$ptitle."', '".html_entity_decode($pcontent)."', '".$date."', '".$prefuid."', '".$preflv."', '".$prefsid."', '".$ptype."', '0', '', '', '0', '".$expirationtime."', '".$attachment."', '".$hide_script."')";
