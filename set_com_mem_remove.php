...
<?php echo "<h2>".$caption."</h2>"; ?>
  ...
  <div id="dragdroparea">	
    <div id="selected_users">
    	...
    	<?php
        $member_list = "";
        //$sql_committee_member_list = "SELECT * FROM committee_member WHERE ref_c_id = '".$committee_id."'";//Marked on February 26, 2011 Saturday
        $sql_committee_member_list = "SELECT * FROM committee_member WHERE ref_pid = '".$pid."'";//New on February 26, 2011 Saturday 
