...
?>
  ...
  $("#ptype").change(function() {
    ...
    if ($("#ptype").val() == 'type2'){
      //alert('Type2');
      $('#title').html('This Species <i>' + taxon + '</i> is synonymized with <select id=\"species_id\" name=\"species_id\">' + species_list + '</select>.' +
            ...
            <tr>
              ...
              <td>
                <select id="ptype" name="ptype">
                  ...
                  <option value="type2">Type 2: This species is synonymized with existing species <?php echo $taxon_name; ?></option>
                </select>
