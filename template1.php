<?php
  ...
  //May 12, 2010 Wednesday:: New Layout template 1
  //February 25, 2011 Friday:: Code change on table_1
  // ./ current directory
  // ../ up level directory
  

  $title = $application_name.":: ".$page_title;
  ...
  if(mysql_num_rows($result_1) > 0){
    ...
    while ( $nb_1 = mysql_fetch_array($result_1) ) {
      $post_title = $nb_1[1];
      $table_1 .= "<p>".substr($nb_1[3], 0, 10)."&nbsp;&nbsp;";//Post date
      $table_1 .= "<a href=\"viewpost.php?pid=".$nb_1[0]."\">".$post_title."</a></p>";
      //$table_1 .= "<tr>\n";
      ...
      //$table_1 .= "<td><a href=\"viewpost.php?pid=".$nb_1[0]."\">".$post_title."</a></td>";//May 07, 2012 Mondat Add
      
      //$table_1 .= "<td><a href=\"viewpost.php?pid=".$nb_1[0]."\"><i>".$post_title."</i></a></td>";//May 07, 2012 Mondat Mark
      //$table_1 .= "<td>".$nb_1[1]."</td>";
      
      
      //$table_1 .= "<td>".substr($nb_1[3], 0, 10)."</td>";//Post date
    ...
    //$table_1 .= "</table>\n";
      ...
      //$table_1 = "There is no data.<br>\n";
  }
  $table_1 .= "<br><div align=\"right\"><p><a href=\"viewallposts.php\">View all posts</a></p></div>\n";
  //
  /*
  $post_title = "";
  $table_1 = "";
  ...
  if(mysql_num_rows($result_1) > 0){
    ...
    while ( $nb_1 = mysql_fetch_array($result_1) ) {
      ...
      //$table_1 .= "<a href=\"viewpost.php?pid=".$nb_1[0]."\"><i>".$sci_name."</i></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;".$nb_1[3]."&nbsp;&nbsp;&nbsp;&nbsp;<a href=\"viewUserProfile.php?uid=".$nb_1[4]."\">".$user_name."</a><br>";
      $table_1 .= "<td><a href=\"viewpost.php?pid=".$nb_1[0]."\"><i>".$post_title."</i></a></td>";
      //$table_1 .= "<td>".$nb_1[1]."</td>";
      $table_1 .= "<td>".substr($nb_1[3], 0, 10)."</td>";//Post date
      //$table_1 .= "<td><a href=\"viewUserProfile.php?uid=".$nb_1[4]."\">".$user_name."</a></td>";
      $table_1 .= "</tr>\n";
  ...
  $table_1 .= "<br><div align=\"right\"><a href=\"viewallposts.php\">View all posts</a></div>\n";
...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<meta name="Description" content="Taxon Name Tracker" />
	<meta name="Keywords" content="Taxonomy, Taxonomic database manageement, Social Networking" />
	<meta name="Distribution" content="Global" />
	<meta name="Author" content="Richard Mayden - cypriniformes@gmail.com, Elvis Hsin-Hui Wu - elviscat@gmail.com" />
	<meta name="Robots" content="index,follow" />

	<!--Does this file edit.css should be keep?-->
...
<body class="twoColLiqLtHdr">
	<div id="container">
		<div id="header">
			<h1><img src="images/taxonnametracker.png" width="593" height="176" /></h1>
			<h2>Taxon Name Tracker: <br />A Cybertaxonomy Platform for Community-driven Biological Scientific Name and Classification Management</h2>
			<!--<h1>North American Fishes & Taxon Tracker</h1>-->
			<div align="center" >
			<?php
				include("menu.php");
    		?>
    		...
    		<br />
  		<!-- end #header --></div>
  		<!--<div id="sidebar1">--><!-- May 07, 2012 Monday Mark-->
  		<!--<div id="sidebar1"  style="border:double; border-width:7px; border-color:orange;">--><!-- May 07, 2012 Monday Mark-->
  		<div id="sidebar1"  style="border:dotted; border-width:2px; border-color:green;">
  			<div class="basic" style="float:left;" id="list1a">
      			...
      			<p><a href="taxon_chg_search.php">- Search Taxon Changes</a></p>
      			<p><a href="viewallchanges.php?date=<?php echo $last_six_months_time; ?>">- Recent Changes (&lt; 6 mo)</a></p>
      			<p><a href="viewallposts.php?view_date=<?php echo $last_six_months_time; ?>">- Recent Posts (&lt; 6 mo)</a></p>
      			<hr>
      			<p><a href="view_pending_proposals_list.php?view_date=<?php echo $last_six_months_time; ?>">- Pending Proposals (&lt; 6 mo)</a></p>
      			<p><a href="view_final_decisions_list.php?view_date=<?php echo $last_six_months_time; ?>">- Final Decisions (&lt; 6 mo)</a></p>
      			<hr>
