...
if( $loginname == "" || $password == "" || $password_confirm == "" || $real_name == "" || $org == "" || $tel == "" || $fax == "" || $eml == "" ){
  ...
  $user_id_base64_encode = base64_encode($maxuid);
  ...
  $mail->Subject = "You have signed up an account on \"Taxon Name Tracker\"  at ".date('l jS \of F Y h:i:s A');
  
  //$mail->Body = "This is the <b>HTML body</b>";
  $mail->Body = "Hi ".$real_name.",<br>";
  $mail->Body .= "Thanks for your interests on Taxon Name Tracker.<br />";
  ...
  if(!$mail->Send()){
    ...
    //echo "Thanks for your interest on Taxon Name Tracker. An e-mail has been sent to the e-mail address provided to confirm it is valid.";
    //Modified on April 05, 2010 Monday
    //Modified on July 07, 2012 Saturday
    echo "Thanks for your interest on Taxon Name Tracker. An e-mail has been sent to your e-mail address!";
    //Modified on July 07, 2012 Saturday
  }
}
mysql_close($link); 
