...
?>
        ...
        <?php
          ...
          //echo "\$table_name is :: ".$table_name."<br>\n";
          if( $table_name == "" ){
          //if( !isset( htmlspecialchars($_GET['table'],ENT_QUOTES) ) ){
            ...
            //$sql_slist_table = "SELECT * FROM ".$sql_table_name." WHERE goes_to = 0 AND is_valid = 1 ".$add_clause." LIMIT ".$start.",".$rows;
