<?php
  ...
  */
  ...
  $sql_user_id_of_committee_members =  "SELECT user_id FROM committee_member WHERE ref_c_id IN ( ";
  $sql_user_id_of_committee_members .=   "SELECT ref_c_id FROM committee_account WHERE LEVEL IN ( ";
  $sql_user_id_of_committee_members .=     "SELECT preflv FROM post WHERE pid ='".$crefpid."'";
  $sql_user_id_of_committee_members .=   ")AND account_id IN ( ";
  $sql_user_id_of_committee_members .=     "SELECT prefsid FROM post WHERE pid ='".$crefpid."'";
  $sql_user_id_of_committee_members .=   ")";
  $sql_user_id_of_committee_members .= ")";
