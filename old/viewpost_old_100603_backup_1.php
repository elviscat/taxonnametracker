<?php 
  ...
  $caption2 .= "Proposed Changes or Suggested Name Changes Detail and Conversation";
  ...
  */
  ...
  $sql_names_committee_member = "SELECT user_id, level FROM committee_member WHERE ref_c_id IN (";
  ...
  if( mysql_num_rows($result_names_committee_member) > 0 ){
    ...
    while ( $nb_names_committee_member = mysql_fetch_array($result_names_committee_member) ) {
      ...
      */
      if( $nb_names_committee_member[1] == "1"){
...
<html>
    ...
    <style type="text/css" title="currentStyle">
        ...
        $("#submit_button").click(function(){
          //alert("Hello, Elvis!!");
          if( $('#ctitle').val() == "" || $('#ccontent').val() == "" ){
            alert("You can't submit a null comment!!");
            return false;
          }
          var review_type = "";
          ...
          //alert('review_type is' + review_type);
          if(review_type.length > 1){
            alert('Between review opinion and decision suggestion, you have to just choose one!');
            return false;
          }
