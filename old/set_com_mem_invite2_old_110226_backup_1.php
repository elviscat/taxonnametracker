<?php 
  ...
  for($i = 0; $i < sizeof($array_selected_users_output);$i++){      
    ...
    $is_removed = 0;
    $sql_is_removed = "SELECT * FROM committee_member WHERE ref_c_id = '".$committee_id."' AND user_id ='".$uid."'";
    ...
    if( $is_removed == 0 ){
      ...
      $sql_set_to_com_mem =  "UPDATE committee_member SET join_status = 'pending' WHERE ref_c_id = '".$committee_id."' AND user_id ='".$uid."'"; 
    }    
