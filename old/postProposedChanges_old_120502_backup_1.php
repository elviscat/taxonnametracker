<?php
  ...
  //Mar 12, 2010 Friday:: modifiy this upload module
  //Mar 17, 2010 Wednesday:: refactoring
  //June 16, 2010 Wednesday:: Apply to new layout
  //Febrary 24, 2011 Thursday:: Apply to new layout
  //May 02, 2012 Wednesday:: Modification and Testing
  // ./ current directory
  // ../ up level directory
  ...
  $page_title = "Submit Taxonomic Revision :: ".taxon_name_without_level($taxon_lv, $taxon_id);
  $page_heading = "Submit Taxonomic Revision :: <i>".taxon_name_without_level($taxon_lv, $taxon_id)."</i>";
