...
<?php echo "<h2>".$caption."</h2>"; ?>
  ...
  <div id="dragdroparea">	
    <div id="selected_users">
    	...
    	<?php
        $member_list = "";
        $sql_committee_member_list = "SELECT * FROM committee_member WHERE ref_c_id = '".$committee_id."' AND (join_status ='accept' OR join_status='pending')"; 
    ...
    <div id="unselected_users">
        ...
        $sql_non_committee_member_list = "SELECT * FROM user WHERE uid not in (SELECT user_id FROM committee_member WHERE ref_c_id ='".$committee_id."')"; 
        ...
        $sql_committee_member_list_removed = "SELECT * FROM committee_member WHERE ref_c_id ='".$committee_id."' AND join_status = 'removed'"; 
