<?php
  ...
  //March 13, 2009 Friday::new blog entry post::insert into the table::post
  // ./ current directory
  // ../ up level directory
  session_start();
  ...
  mysql_select_db($dbname);
  //sql statement
  $sql = "INSERT INTO post (`pid`, `ptitle`, `pcontent`, `pcredate`, `prefuid`, `pcount`, `ptag`, `pcategory`) VALUES ";
  $sql .= "('".$maxPid."', '".$ptitle."', '".$pcontent."', '".$date."', '".$prefuid."', '0', '".$ptag."', '".$pcategory."')";
  //echo $sql;
  mysql_query($sql);
  mysql_close($link);
