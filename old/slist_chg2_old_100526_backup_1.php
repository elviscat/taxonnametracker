<?php 
  ...
  */
  ...
  $insert_sql = "INSERT INTO namelist_chglog (`id`, `reflv`, `refid`, `refpid`, `chg_note`, `rea`, `decision`, `chgdate`, `chgtime`) ";
  $insert_sql .= "VALUES ('$maxid', '$reflv', '$id', '$refpid','$chg_note', '$rea','$decision', '$regdate', '$regtime')";
  //echo "insert_sql is ".$insert_sql."<br>\n";
  $result=mysql_query($insert_sql);

  //Also change the pstate in TABLE::post associated with the pid
  ...
  $update_sql = "UPDATE post SET pstate ='".$pstate."' WHERE pid ='".$refpid."'";
  //echo "update_sql is ".$update_sql."<br>\n";
  mysql_query($update_sql);
