      ...
      <!--Code is here!-->
          ...
          <table class="example" id="dnd-example">
            ...
            <tbody>
              ...
              <?php
                        $sql3 = "SELECT * FROM slist WHERE sfamily ='".$nb_sql[11]."' and sgenus ='".$nb_sql2[2]."' AND is_valid ='1'";
              ...
              <tr id="node-<?php echo $counter_of_family; ?>-<?php echo $counter_of_genus; ?>-<?php echo $counter_of_species; ?>" class="child-of-node-<?php echo $counter_of_family;?>-<?php echo $counter_of_genus;?>">
                ...
                <td>
                  <?php
                    ...
                    echo "<input type=\"checkbox\" name=\"check_account\" value=\"species;".$nb_sql3[0].";".$nb_sql3[2]." ".$nb_sql3[3]."\"";
                    echo ">";
                  ?>
                </td>
              </tr>
