<?php 
  ...
  //Dec 21, 2009 Monday:: view post list
  ...
  if( mysql_num_rows($result) > 0 ){  
    while ( $nb2 = mysql_fetch_array($result) ) {
      ...
      $table .= "<h3><B><font color=\"black\"><a href=\"viewpost.php?pid=".$pid."\">".$nb2[1]."</a></font></B></h3>";//Title
      ...
      */
      ...
      $table .= "<B><font color=\"blue\">".$post_author_name."</a></font></b><BR>";//Posted by Author
      $table .= "<font color=\"black\">".$nb2[2]."</font><BR>";//Post Content      
      $table .= "<h3><B><font color=\"blue\"><a href=\"viewcommentlist.php?pid=".$pid."\">".$commentCount."</font> comments</B></h3>";//Comment Counter
