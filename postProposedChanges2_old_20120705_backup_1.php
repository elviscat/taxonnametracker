<?php 
  ...
  //July 03, 2012 Thursday:: Change the logic!
  ...
  */
  ...
  if( $ptype == "type1" ){//If ptype equal "type1", then include all new species information in the following...
    ...
    //echo "\$target_species_id is : ".$species_id."<br />\n";
	...
	$sql_insert_new .= "('$maxSid', '".$prefsid."', '0', '".$sfamily."', '".$sgenus."', '".$sspecies."', '".$sauthor."', '', '".$scommon_name."', '', '', '', '0', '1', '$maxPid')";
  ...
  */
  ...
  if( $preflv == "" && $prefsid == ""){
    ...
    echo "\$insertpost__sql is <b>".$insert_post_sql."<b><br>\n";
