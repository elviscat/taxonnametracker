<?php
  ...
  $caption = "List of Committee Memebrs in this Review Committee";
...
?>
      ...
      <?php
        ...
        if(mysql_num_rows($result_list_committee_members) > 0){
          ...
          echo "Review Committee is not initilized, please go to following link to set up:<br>\n";
          echo "<br>\n";
          echo "<a href=\"set_com_mem_init.php?pid=".$pid."\">Set up this Review Committee.</a><br>\n";
        ...
        */
		...
		echo "<a href=\"admin_proposal_management.php\">Back to Taxonomic Change Proposal List</a><br>\n";
