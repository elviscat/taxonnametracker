<?php 
  ...
  //July 06, 2012 Friday::Modification::revision on layout editing
  // ./ current directory
  // ../ up level directory
?>
...
<a href=postproposedchangemenu.php>Submit a Taxonomic Change Proposal</a>

<!--Fourth Link::Administration Page-->
<?php
  if( isset($_SESSION['is_login']) ){
    echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
    echo "<a href=\"admin.php\">Administrative Dashboard</a>";
  }
?>
