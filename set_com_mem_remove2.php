<?php 
  ...
  */
  ...
  for($i = 0; $i < sizeof($array_unselected_users_output);$i++){      
    ...
    //$sql_set_to_com_mem =  "UPDATE committee_member SET join_status = 'removed' WHERE ref_c_id = '".$committee_id."' AND user_id ='".$uid."'";//Marked on February 26, 2011 Saturday
    $sql_set_to_com_mem =  "UPDATE committee_member SET join_status = 'Removed' WHERE ref_pid = '".$pid."' AND ref_uid ='".$uid."'";
