<?php
	...
	*/
	...
	if( $role == "user" ){
		$content .= "<li><h3>Your Assignments with the Review Committee</h3></li>";
		//$content .= "1.<a href=\"view_user_committee_list.php\">View your assigned Names Committees</a><br>";
		$content .= "<a href=\"view_user_committee_list.php\">View your assigned Review Committees</a><br>";
    ...
    */
	...
	$content .= "<li><h3>Your Proposals and Comments</h3></li>";
	
	//$content .= "<a href=\"postProposedChangesManage.php\">View your proposed nomenclatural changes</a><br>";
    
    $content .= "<a href=\"browse_taxonomic_change_proposals.php\">View your taxonomic change proposals</a><br>";
    ...
    $content .= "<a href=\"browse_user_comments.php\">View your comments</a><br>";
    ...
    $content .= "<li><h3>Taxonomic Change Proposal Management</h3></li>";
    
    //$content .=  "<a href=\"admin_proposal_management.php\">Nomenclature Change Proposals List</a><br>\n";
    $content .=  "<a href=\"admin_proposal_management.php\">Taxonomic Change Proposals List</a><br>\n";
    ...
    */
    ...
    $content .= "<li><h3>Review Committee Management</h3></li>";
    ...
    $content .= "<a href=\"committee_list.php\">Review Committee List</a><br>"; //View names committee list
    ...
    $content .= "<a href=\"set_default_com_mem.php\">Set and Unset Default Review Committee Member(s)</a><br>"; //Set up and unset the default names comiittee member(s) 
