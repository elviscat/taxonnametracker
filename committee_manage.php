<?php
  ...
  //June 25, 2010 Friday:: Names Committee List
  //February 26, 2010 Saturday:: Code Logic Modification
  // ./ current directory
  // ../ up level directory
      ...
      <?php
        ...
        if(mysql_num_rows($result_sql_committee) > 0){
          ...
          while ( $nb2 = mysql_fetch_array($result_sql_committee) ) {
            ...
            echo "<td>";
            echo "<a href=\"view_completelist_comm_mem.php?pid=".$nb2[4]."\">View</a><br>\n";            
            echo "</td>";
