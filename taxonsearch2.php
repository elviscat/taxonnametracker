<?php
  ...
  //July 07, 2012 Saturday:: Total Logic Modification
  // ./ current directory
  // ../ up level directory
  ...
  //echo "\$lv is view_date:: ".$view_date."<br>\n";
        ...
        <?php
          ...
          if( $special_level == "" ){
            ...
            if($search_level == "family"){
              $sql_taxon_search = "SELECT * From slist WHERE sfamily ='".$search_word."'";
            }elseif($search_level == "genus"){
              $sql_taxon_search = "SELECT * From slist WHERE sgenus ='".$search_word."'";
            }elseif($search_level == "species"){
              $array_search_word = explode(" ", $search_word);
              
              $sql_taxon_search = "SELECT * From slist WHERE sgenus='".$array_search_word[0]."' AND sspecies ='".$array_search_word[1]."'";
            }
            ...
            if(mysql_num_rows($result_taxon_search) > 0 ){
            	...
            	$table_content .= "<tr>";
            	$table_content .= "<td>Taxon Name</td>";
              /*
              if( $search_level == "family"){
                $table_caption = "<tr>";
              ...
              */
              ...
              while ( $nb_taxon_search = mysql_fetch_array($result_taxon_search) ) {
              	$table_content .= "<tr>";
              	$table_content .= "<td><a href=\"viewtaxon.php?lv=species&id=".$nb_taxon_search['sid']."\">".$nb_taxon_search['sgenus']." ".$nb_taxon_search['sspecies']."</td>";
                $table_content .= "</tr>";
                /*
                if( $search_level == "family"){
                  $table_content = "<tr>";
                ...
                */                
                ...
                echo "\$sql_count_post is ".$sql_count_post."<br />\n";
