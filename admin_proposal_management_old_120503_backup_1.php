  ...
  if(mysql_num_rows($result_all_post) > 0){
    ...
    while ( $nb_all_post = mysql_fetch_array($result_all_post) ) {
      ...
      if( $pstate == "Submitted" ){//State:: Submitted
        $content .= "<td>Submitted  <a href=\"view_completelist_comm_mem.php?pid=".$pid."\"><input type=\"image\" name=\"go\" src=\"images/botton_gif_027.gif\" /></a></td>\n";
      }elseif( $pstate == "Under Review" ){//State:: Under Review::Comment, Review Opinion, and Vote
        $content .= "<td>Under Review  <a href=\"viewpost.php?pid=".$pid."\"><input type=\"image\" name=\"go\" src=\"images/botton_gif_027.gif\" /></a></td>\n";
      }elseif( $pstate == "Pending" ){//State:: Pending::Administrator have to make decision
        $content .= "<td>Pending  <a href=\"viewpost.php?pid=".$pid."\"><input type=\"image\" name=\"go\" src=\"images/botton_gif_027.gif\" /></a></td>\n";
      }elseif( $pstate == "Closed" ){//State:: Closed::Nothign to do
        $content .= "<td>Closed  <a href=\"viewpost.php?pid=".$pid."\"><input type=\"image\" name=\"go\" src=\"images/botton_gif_027.gif\" /></a></td>\n";
      } 
      $content .= "</tr>\n";
    }  
    $content .= "</table>\n";
