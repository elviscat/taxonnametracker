<?php 
  ...
  */
  ...
  if( $ptype == "type1" ){//If ptype equal "type1", then include all new species information in the following...
    ...
    $ptitle = "New Species <i>".$sgenus."</i> ".$sspecies." is described out of <i>".$ori_species_name."</i>.";
    
    //echo $sgenus;
    //echo $sspecies."<br>\n";
    
    $p_operation_script_1 = "INSERT INTO `taxon_name_tracker`.`slist` (`sid` ,`sfamily` ,`sgenus` ,`sspecies` ,`sauthor` ,`sloc` ,`scommon_name` ,`scnam1` ,`scnam2` ,`scnam3` ,`is_valid` ,`synonym_of`) VALUES ";
    $p_operation_script_1 .= "(\'1\', \'".$sfamily."\', \'".$sgenus."\', \'".$sspecies."\', \'".$sauthor."\', \'\', \'".$scommon_name."\', \'\', \'\', \'\', \'Yes\', \'0\')";
    //('391', '1', '2', '3', '4', '5', 'abc;def', '7', '8', '9', '10', '11');
    //echo "Variable p_operation_script_1 is <b>".$p_operation_script_1."<b><br>\n";
    $p_operation_script_2 = "INSERT INTO `taxon_name_tracker`.`slist` (`sid` ,`sfamily` ,`sgenus` ,`sspecies` ,`sauthor` ,`sloc` ,`scommon_name` ,`scnam1` ,`scnam2` ,`scnam3` ,`is_valid` ,`synonym_of`) VALUES ";
    $p_operation_script_2 .= "(\'1\', \'".$sfamily."\', \'".$sgenus."\', \'".$sspecies."\', \'".$sauthor."\', \'\', \'".$scommon_name."\', \'\', \'\', \'\', \'No\', \'".$prefsid."\')";
    //echo "Variable p_operation_script_2 is <b>".$p_operation_script_2."<b><br>\n";
  ...
  */
  ...
  if( $preflv == "" && $prefsid == ""){
    ...
    $insert_sql .= "('".$maxPid."', '".$ptitle."', '".html_entity_decode($pcontent)."', '".$date."', '".$prefuid."', '".$preflv.":".$prefsid."', '".$ptype."', '0', '', '', 'Submitted', '".$expirationtime."', '".$attachment."', '".$p_operation_script_1.":".$p_operation_script_2."', 'Pending')";
    //echo "Variable insert_sql is <b>".$insert_sql."<b><br>\n";
